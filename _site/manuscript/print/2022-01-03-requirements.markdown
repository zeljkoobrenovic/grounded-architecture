...
A> **KEY POINTS:**
A> * I identified four needs an architecture practice should support: **Executing At Scale, Adaptivity, Improving Decision-Making with Data, and Maximizing Organizational Alignment & Learning**.
