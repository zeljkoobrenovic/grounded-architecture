...
A> ***KEY POINTS:***
A> * This book shares **my approach to running an IT architecture practice** in larger organizations, based on my experience at AVIV Group, eBay Classifieds, and Adevinta. I call this approach **"Grounded Architecture"**: architecture with strong foundations and deep roots.
A> * **Grounded Architecture** prioritizes **people interactions and data** over processes and tools, connecting an architecture practice to all organizational levels as an antidote to the "ivory tower" architecture.
A> * I also explain **my motivation for writing this book**.
