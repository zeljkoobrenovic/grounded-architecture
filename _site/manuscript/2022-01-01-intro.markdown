...
This book will introduce Grounded Architecture as an architecture function system with two main parts:
...
* **Guiding Principles**, where you will get guidelines and hints on how to put the ideas of Grounded Architecture into practice.
...
The *[Data Pillar](#data)* will teach you how to define a system of tools, resources, and processes to ensure that architects' decisions are data-informed, based on an up-to-date and complete overview of the organization's technology landscape.

The *[People Pillar](#people)* will teach you how to create a strong network of people doing architecture across the organization, which is crucial to ensure that the architecture function has any tangible impact.

Lastly, the *[Architecture Activities Platform](#activities-platform)* will teach you how to define a set of processes and agreements enabling architects to do everything architecture typically does, leveraging data and People Pillars to create a data-informed, organization-wide impact.

As a part of my work on Grounded Architecture, I also provide several guiding principles I learned while developing ideas of Grounded Architecture in practice, grouped into two parts:
...
The three parts of the book (Structure, Being Architect, and Doing Architecture) correspond to the aspects of work of Chief Architects or Heads of Architecture that need to set up and run modern IT architecture practices:
...
When writing this book, I had a broad audience in my mind. The article should be helpful to both technical and non-technical people. The book can help IT architects to better understand their value and place in a broader organization. I also hope the articles show the broader audience the benefits of staying close to and well-connected with the technologists.
...
In the third part, I talk about the Guiding Principles of Grounded Architecture, grouped int to sections: Being Architect and Doing Architecture. 
