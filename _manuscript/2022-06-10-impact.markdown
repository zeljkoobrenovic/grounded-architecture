...
* **Identifying, tackling, and delivering on strategic problems** at the organizational and area levels (domain or technical
...
* **Having a deep and/or broad influence** on a domain, product, or technology area. Architects sometimes need to go deep,
  addressing specific critical issues in one area. And frequently they need to look broad, creating impact by leveraging
...
* Seeing the **big picture** to identify high leverage points for maximum impact.
* **Helping others to see the big picture** and create tools (e.g., [Data Pillar](#data)) that facilitate big-picture thinking.
* Being able to **zoom in and out**, having a strategic overview, but going deep and engaging with implementation details.
...
the bar on the technical and cultural fronts. I group such roles of architect in three categories:
...
Architects should be leading authority for systematic and strategic design and architecture topics:
...
* *What initiatives can you take to improve collaboration and build trust within your organization?*
...
* *In what ways can you help solving important problems in your area and raise the bar of the engineering culture across the company?*
