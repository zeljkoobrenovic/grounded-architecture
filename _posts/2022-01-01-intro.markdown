...
timetoread: 15 min
excerpt: "This playbook will explain explain my approach to running an IT architecture practice in larger organizations. I called this approach \"Grounded Architecture,\" highlighting the need for any IT architecture function to stay well-connected to all levels of an organization and led by data."
...
The *[Data Pillar](data-pillar)* ensures that architects' decisions are data-informed, based on a real-time and complete overview of the organization's technology.
