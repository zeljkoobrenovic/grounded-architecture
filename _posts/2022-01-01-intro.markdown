...
* [**Design Instability**](https://design-instability.com/) co-authored with Erik Stolterman, is a collection of essays where we connected experiences of designing/architecting in three disciplines: classical design, UX design, and software engineering. This work has helped me better relate to and learn from non-technical disicplines, which is necessary for architecture work.
