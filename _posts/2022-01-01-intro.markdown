...
Figure 1 shows the Grounded Architecture framework consisting of three elements:
...
If all this is not enough, in the appendix I outline several online resources that have proven vital in my journey as an IT architect and have reminded me about what I always need to know about crucial aspects of IT practice. I routinely refer back to them and carry them in my practitioner "backpack," so I added their summaries in the online [appendix](appendix), including:
...
Different parts of the book correspond to the aspects of work of **Chief Architects** or **Heads of Architecture** that need to set up and run modern IT architecture practices:
...
While fundamental structures and practices may be consistent across diverse business scenarios, the most crucial elements—akin to fresh, **local ingredients** in cooking—must be procured locally. The staff's skills, experiences, and insights are the secret ingredients that personalize and refine the architecture to align with specific business needs and goals. They are what render the architecture truly unique and effective.
...
Many other sources have influenced my work. Some of them you can find in the online [Bookshelf appendix](https://grounded-architecture.io/bookshelf).


## Why This Book?

This book **generalizes my experiences** in written form. I have written these articles for several reasons. Firstly, writing helps me clarify and improve my ideas (Figure 2). As Gregor Hohpe once noted, every sentence I write frees up brain cells to learn new things. 
...
In the second part, I discuss the Grounded Architecture framework and describe its three elements: the Data Foundation, the People Foundation, and the Architecture Activities Platform. 
...
Finally, I conclude with a summary and encourage you to explore further with the help of the plentiful external resources I've provided, supporting your journey of understanding and implementation.
