...
<br>
Have you ever wondered how to operate an IT architecture practice without **feeling isolated in an ivory tower**? Look no further! This book shares an approach to running an IT architecture practice in larger organizations, drawing from my experiences at AVIV Group, eBay Classifieds, and Adevinta. I call this approach "**Grounded Architecture**" because it emphasizes **keeping your feet on the ground** and ensuring your architecture is **firmly rooted in reality**.

The approach presented in this book connects architecture to every aspect of your organization, ensuring that you are not just a lone wizard in a tower casting spells that no one understands. Grounded Architecture **prioritizes relationships with people and data** over elaborate theories, processes, and tools. This book will provide new insights into IT architecture, redefining it as a **collaborative, adaptable, and outcome-oriented practice**.

The term "Grounded Architecture" is **inspired by the Grounded Theory** methodology. Grounded Theory involves developing theories based on real-world data rather than deriving them from abstract concepts. Similarly, Grounded Architecture **evolves from honest feedback and data** rather than outdated books filled with theoretical principles.

## Grounded Architecture Overview

This book presents Grounded Architecture in two main parts (see Figure 1):

* **Framework:** This section provides the essential elements to establish your Grounded Architecture practice. 
* **Guiding Principles:** This part offers useful tips and inspiration to help you effectively implement Grounded Architecture's elements.

![](assets/images/model.png)
***Figure 1:**  Grounded Architecture Overview.*

<br>
The Grounded Architecture framework consists of three key elements:

1. **Lightweight Architectural Analytics (Data)**: This element ensures that architectural decisions are based on accurate and comprehensive information about your organization's technology landscape.

2. **Collaborative Networks (People)**: This aspect emphasizes the importance of having a strong network of individuals involved in architecture throughout your organization, ensuring that your efforts are impactful.

3. **Operating Model**: The operating model encompasses several sections: 
   - **[General Principles](operating-model)**: An effective architecture practice must be tailored to the organization's unique needs. It should be based on collaboration, clear rules of engagement, and a focus on enabling teams through strategic alignment, distributed decision-making, and supported standards, such as golden paths.
   - **[Cooperation-Based Operating Model](six-simple-rules)**: The Grounded Architecture operating model is collaborative. It focuses on establishing organizational structures based on cooperation, allowing architects to work effectively with others and make a meaningful impact. One helpful approach for fostering this collaborative mindset is the Six Simple Rules method, developed by Yves Morieux and Peter Tollman. This framework encourages organizations to adapt to complexity by promoting autonomy and cooperation among their members.
   - **[IT Governance: Nudge, Taxation, Mandates](governance)**: A technology governance model is essential for any architecture operating model. I assert that IT governance should be a balanced hybrid of three governance styles: mandates, bans, taxes, and nudging.
   - **[Leveraging the Potential of Generative AI within the Grounded Architecture Framework](gen-ai-potential)**: As someone actively involved in architectural practices in complex environments, I have experimented with Generative AI tools to enhance our workflows. Below are initial insights, lessons learned, and practical suggestions for other architects interested in similar enhancements.



These sections outline a framework of processes and agreements that enable architects to thrive by leveraging data and collaborative connections, ultimately creating a powerful, organization-wide impact.
