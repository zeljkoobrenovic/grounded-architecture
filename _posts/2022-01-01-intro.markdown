...
Lastly, the *[General Operating Model](operating-model)* and *[Cooperation-Based Operating Model](six-simple-rules)* define a collection of processes and agreements that lets architects do their thing, leveraging data and people connections to create a powerful, organization-wide impact.
