...
* [Characteristics of High Performing Organizations](https://grounded-architecture.io/high-performing-organizations)
* [Building Data Foundation Website: Lean Design Patterns and Techniques](https://grounded-architecture.io/data-website)
...
Many other sources have influenced my work. Some of them you can find in the [Bookshelf section](https://grounded-architecture.io/bookshelf).
...
In the second part, I discuss the Grounded Architecture framework, describing its three elements: the Data Foundation, the People Foundation, and the Architecture Activities Platform. 
