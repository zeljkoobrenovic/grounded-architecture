...
> ***KEY POINTS:***
>
> * This book shares **my approach to running an IT architecture practice** in larger organizations, based on my experience at AVIV Group, eBay Classifieds, and Adevinta. I call this approach **"Grounded Architecture"**: architecture with strong foundations and deep roots.
> * **Grounded Architecture** prioritizes **people interactions and data** over processes and tools, connecting an architecture practice to all organizational levels as an antidote to the "ivory tower" architecture.
> * I also explain **my motivation for writing this book**.
...
<br>
How do you run an IT architecture practice without becoming detached from the people, problems, and decisions that shape the organization?

This book is my answer to that question. More specifically, it is an argument that architecture becomes effective only when it stays close to the organization it is trying to help: close to teams, close to decisions, close to evidence, and close to outcomes.

Based on my experiences at AVIV Group, eBay Classifieds, and Adevinta, I introduce an approach I call **Grounded Architecture**. It is a **practical, human-centered approach** built around real-world constraints, timely data, and close collaboration with the people doing the work.

Grounded Architecture keeps architecture **connected to reality**. Its aim is to make architecture relevant, collaborative, and responsive in fast-moving environments. Rather than treating architecture as a collection of abstract frameworks, it treats it as a living discipline rooted in relationships, outcomes, and continuous learning.

In many organizations, architects are still seen as remote specialists who produce documents no one reads and models no one uses. Grounded Architecture is an alternative: **an architecture practice embedded in the organization itself**, connected to strategy, delivery, operations, and the teams building the systems.

This approach places data and collaboration at the center instead of relying on heavyweight processes or elaborate tooling. It **draws inspiration from Grounded Theory**, a research methodology that develops theories from observed reality rather than abstract assumptions. In the same spirit, Grounded Architecture evolves through feedback, usage, and measurable impact.
...
Beyond the framework, this book offers a set of **practical tools and reflections** that explore the human, strategic, and behavioral dimensions of architecture. These sections are not side topics. They explain how architects turn the framework into daily practice: by building judgment, understanding people, and connecting technology choices to business direction. These principles are grouped into thematic areas:
...
#### [**Notes On Human Complexity**](human-complexity) (Book 3)
...
Before diving into the full framework, I want to explain **why** I wrote this book and what kind of architecture practice this book is trying to help build.
...
I like to think of starting or improving an architecture practice as a form of **culinary craft**.

Imagine arriving at a new company like a chef entering an unfamiliar kitchen with a well-used set of tools and techniques. The first task is not to impose a menu, but to understand the **local ingredients**.
...
I will share recipes and methods, but the central lesson remains the same: **you will always need to adapt to your local ingredients**.
...
Much of the work in this book stems from my current role as **Chief Architect at AVIV Group**, **eBay Classifieds** and **Adevinta**. These experiences have enabled me to lead architectural practices in **large, complex, and rapidly evolving organizations**, skillfully balancing long-term strategy with ever yday realities.
...
That is the thread running through the chapters that follow. First, I define the framework itself: the data, networks, and operating model that make architecture scalable. Then I move outward into the human and strategic disciplines that determine whether that framework becomes useful in practice. If the book works as intended, each section should help you connect architecture more firmly to execution, learning, and organizational change.
