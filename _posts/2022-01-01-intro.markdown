...
<br>
In recent years, we have witnessed several shifts in the role of IT architects. Gregor Hohpe's book The [Software Architect Elevator](https://architectelevator.com/) has defined a new vision of a software architect's essential role in an organization, particularly in bridging the gap between high-level, abstract decision-making and low-level technical implementation. In the metaphor, the software architect operates like an elevator, moving between different levels of an organization, needing to speak and understand the language of both business executives and technical developers, translating and aligning their goals and requirements.


While there is significant consensus about the Software Architecture vision when you want to set an architecture function according to this vision, there are very few practical guidelines about how to do it in practice. How to define new roles closer to a modern view of architecture? How to form teams? What tools to use or build? How to grow and develop architects?

To answer these questions, we must share lessons we learned while applying the ideas in practice on complex projects. Even if limited in scope, such studies of our peers have much more value for practitioners than abstract debates or academic analyses. 

With this playbook, I want to share lessons I learned from implementing Software Architecture Elevator ideas in practice. I will describe an approach to running an IT architecture practice in larger organizations inspired by the views of the Software Architecture Elevator vision called "grounded architecture." I used the term "grounded architecture" to highlight the need for any IT architecture function to stay well-connected to all levels of an organization and led by data. This playbook aims to share my approach to running an IT architecture practice in larger organizations based on my experience as Chief Architect at AVIV Group, eBay Classifieds, and Adevinta.


<div class="quote">
I called my approach "grounded architecture," highlighting the need for any IT architecture function to stay well-connected to all levels of an organization and led by data.
</div>
...
The *[Data Pillar](data)* ensures that architects' decisions are data-informed, based on a up-to-date and complete overview of the organization's technology landscape.
