...
1. **[Lightweight Architectural Analytics (Data)](data)**: This element ensures that your architectural decisions are grounded in accurate and comprehensive information regarding your organization's technology landscape.

2. **[Collaborative Networks (People)](people)**: This aspect emphasizes the importance of a robust network of individuals working on architecture throughout your organization, ensuring that your efforts are impactful.

3. **Operating Model**: The operating model includes several sections: 
   - [General Principles](operating-model)
   - [Cooperation-Based Operating Model](six-simple-rules)
   - [IT Governance: Nudge, Taxation, Mandates](governance), and as a bonus
   - [Leveraging The Potential of Generative AI within Grounded Architecture Framework](gen-ai-potential)
