...
timetoread: 15 min
excerpt: "This playbook describes the lessons I learned in running an IT architecture practice in larger organizations. I called this approach \"Grounded Architecture,\" highlighting the need for any IT architecture function to stay well-connected to all levels of an organization and led by data."
...
> **KEY POINTS:**
>
> * This playbook describes the lessons I learned in running an IT architecture practice in larger organizations. 
...
This playbook describes the lessons I learned in running an IT architecture practice in larger organizations. I called this approach "grounded architecture," highlighting the need for any IT architecture function to stay well-connected to all levels of an organization and led by data. 
