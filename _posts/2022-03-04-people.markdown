...
So, you cannot just 3D print your architects or hire them in buckets. But what you can do is to carefully organize, empower, and leverage this scarce talent (Figure 1). A strong network of people doing architecture is crucial for any real impact. In simpler terms, **Strong Architecture = Strong Architects**.
...
While each organization will need its unique approach, here are some tips I found helpful when forming architecture teams and building a "[Collaborative Networks](people)":
