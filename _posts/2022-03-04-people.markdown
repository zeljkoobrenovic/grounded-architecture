...
To operate in our complex context, we have invested effort to ensure we have the right people at the right places. In the end, the adopted model was a hybrid organization combining elements of central and federated orientation structures:
...
* Build and maintain the architecture [Data Pillar](data-pillar). Building a data pillar requires clear ownership, curation, and full-time support.
...
* Build internal architecture communities and guilds
...
Having places and events to connect central and distributed teams is essential. Such events can transform individual experiences into collective knowledge that can benefit the whole organization.
