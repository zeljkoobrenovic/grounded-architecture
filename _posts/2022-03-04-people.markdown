...
organizational, and technology issues. Architects are difficult to hire because they need in-depth technical, domain-specific, and organizational knowledge. Therefore, we need to support, organize, and leverage
architecture talent."
...
architecture teams and "[People Foundation](people)":
