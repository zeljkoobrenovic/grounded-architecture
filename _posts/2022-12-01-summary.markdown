...
In this collection of articles, I explained my approach to running an architecture practice in larger organizations. I called this approach "grounded architecture," highlighting the need for any architecture function to stay well-connected to all levels of an organization and led by data. The Grounded Architecture model consists of three elements:
* The Data Pillar,
* The People Pillar,
