...
To operate in our complex context, we have invested effort to make sure that we have right people at the right places. We have opted for a hybrid organizational morning combining elements of Central and federated orientation structures. Consequently we have free key elements of our people dimensions:

* Central Architectural Teams (CATs),
* Architecture Guilds & Virtual Architectural Teams (VATs),
* Architecture Community Building Events
...
### Architecture Guilds & Virtual Architecture Team (VAT)

Organization members who are passionate about archietcture can form a Guild, a community of interest. Anyone can join a Guild and they are completely voluntary.

A virtual architectural team is a stronger from of a guild with some minimal amount of commitment. It composed of people that work full-time as architects or tech leads in specific organization or units but spending part time collaborating with architects from other units to reach more alignment, share knowledge, and leverage eachs other’s work.
