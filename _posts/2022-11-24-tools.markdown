...
<td>
<b>Architecture Dashboard Examples</b>: source code of examples of how to build the Architecture Data Dashboard as a part of the Grounded Architecture Data Foundation. The dashboard is a simple static website generated from JSON files and published via GitHub pages.
</td>
