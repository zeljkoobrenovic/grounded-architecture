...
I argue here that these four directions are legitimate motivators for doing architecture work, and that we need to have efforts in all of them. Indeed, each of these motivators has positive and negative sides, and awareness of the pros and cons can help us to do better work. I also contend the main question is not which of these directions to follow, but rather, what is the right balance among contributions motivated by all four sides.
...
As the simplest and the most obvious point of the architecture compass, curiosity and wonder describe the natural characteristic of architects to have a strong interest in and eagerness to know more about a topic. Many innovative contributions came from people being fascinated by or curious about some issue, including technology, people, or interaction between technology and people.
...
Vision is a very important component of any organizational effort, as shared vision can inspire people and enable synergic developments. 
