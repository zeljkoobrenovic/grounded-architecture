...
> **KEY POINTS:**
>
> * Grounded Architecture structure has three elements: The Data Pillar, The People Pillar, and The Architecture Activities Platform.
...
> * The People Pillar is a strong network of people doing architecture across the organization, ensuring that the architecture function has a tangible impact. 
...
The *Data Pillar* is a collection of tools and resources that enables architects to make data-informed decisions based on a real-time and complete overview of the organization's technology landscape. The [Data Pillar section](data-pillar) provides more details.

The *People Pillar* is a network of people doing architecture across the organization. This Pillar is crucial to ensure that architecture function has any tangible impact. As noted by Gregor Hohpe, to transform an organization, you do not need to solve mathematical equations; you need to move people. The [People Pillar section](people-pillar) provides more details.
