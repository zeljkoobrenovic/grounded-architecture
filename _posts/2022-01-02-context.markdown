...
icon: global.png
timetoread: 15 min
excerpt: The architecture function has developd in the context of organizations that were global, loosely coupled, very diverse, under syndergy and transformation pressures, and with non-linear growth dynamics.
...
Architectural diversity:
* Old Monoliths
* Modern Microservices and serverless
