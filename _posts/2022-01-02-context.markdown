...
The work I present here reflects my as a Principal Architect at eBay Classifieds and Adevinta. After a year of working for eBay Classifieds, Adevinta and eBay Classify merged, where I continued the same work on a bigger scale. In this section, we discuss critical characteristics of the organizational context that have had an impact on my definition of the grounded architecture approach:
