...
The competency development of architects should be driven by the impact they need to have rather than mere skills development. I typically coach architects in the context of concrete activities, guiding their development via involvement in the right set of actions and crafting skills developments based on challenges in making an expected impact in practice. 
...
<div style="font-size: 80%; color: grey; margin-bottom: 12px; text-align: center">
<b>Figure 1</b>: Key competencies of architects. Credit: inspired by The Staff Engineer's Path by Tanya Reilly.
</div>
...
* **Helping others to see the big picture** and create tools (e.g., [Data Pillar](data-pillar)) that facilitate big-picture thinking.
...
As execution-fouces practitioners, architects need to be able to help deliver results, and improve collaboration.
