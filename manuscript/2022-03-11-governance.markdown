...
A> **KEY POINTS:**
A> * Architecture practice should support **adaptable governance models**. A strong technology governance model is a balanced hybrid of **mandates and bans, taxes, and nudging**.
A> * **Nudging** influences behavior through **subtle suggestions** without removing freedom of choice.
A> * **Taxes and economic incentives** guide choices by attaching a cost to using certain resources.
A> * **Mandates and bans** guide people by explicitly defining **what they should or should not do**.
