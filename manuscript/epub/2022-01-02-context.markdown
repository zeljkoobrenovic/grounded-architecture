...
To truly grasp any idea or solution, you need to understand the context in which these ideas were born. My work on creating and running an architecture practice isn't just a lofty idea; it's a practical approach sharpened from real-world experience. My perspective comes from lessons I learned as a Chief Architect at AVIV Group and Principal Architect at eBay Classifieds and Adevinta. Here's a peek into the context that shaped my Grounded Architecture approach:
...
* **Nonlinear growth dynamics**: in addition to organic growth, big organizations change their portfolio through mergers and acquisitions of new businesses or divestments.
...
Balancing opportunities and challenges on a global scale has been one of the most demanding and rewarding aspects of my architectural work.
...
For instance, I worked with organizational units differing in several aspects:
...
Technology-wise, we managed a range of styles in active production systems, from legacy **monolithic** applications to intricate modern **microservice and serverless** ecosystems. Each organizational segment had its own unique history and legacy systems.
...
![image by istock](assets/images/iStock-1321965054.jpg)
