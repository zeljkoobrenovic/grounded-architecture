...
This book introduces Grounded Architecture as an IT architecture practice system with two main parts:
* **Structure**, defining elements you need to have to run Grounded Architecture practice, and
* **Guiding Principles**, a set of guiding principles that can help put the ideas of Grounded Architecture into practice.
...
The *[People Pillar](#people)* is another essential element of Grounded Architecture. A strong network of people doing architecture across the organization is crucial to ensure that architecture function has any tangible impact.
...
In the second part, I discuss the Grounded Architecture structure describing its three elements: the Data Foundation, the People Pillar, and the Architecture Activities Platform. 
