...
![image by pexels from pixabay](assets/images/arch/board-3317496_1280.jpg)
...
* **Keep Components Loosely Coupled:** Hide most of the files in a component from direct dependencies from other components.
...
* **Time Behavior:** Degree to which a product or system's response, processing times, and throughput rates meet requirements when performing its functions.
