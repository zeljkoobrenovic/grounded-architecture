...
A> **KEY POINTS:**
A> * IT architects can enhance their leadership and influence by adopting **six communication plays** from David Marquet's *Leadership is Language*.
A> * These plays, **Control the Clock, Collaborate, Commit, Complete, Improve, and Connect**, foster better thinking, execution, and team engagement.
A> * Applying these plays helps architects build **trust**, encourage **psychological safety**, and unlock stronger **buy-in**.
A> * The principles align directly with **Grounded Architecture** by promoting **data-driven decisions, collaborative networks, adaptability, and strategic impact**.
...
![](assets/images/istock/iStock-1729458143.jpg)
