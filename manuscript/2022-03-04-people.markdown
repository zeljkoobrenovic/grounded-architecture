...
A> **IN THIS SECTION, YOU WILL:**  Understand that architecture is about people and get hints and tips on creating organizational structures that support practical architecture functions.
A>
