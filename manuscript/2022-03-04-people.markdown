...
![image by simonkr from istock](assets/images/istock/iStock-480342200.jpg)
...
* **Build and maintain the architecture [Lightweight Architectural Analytics](#analytics).** With all AI advances, it will not build itself! You need clear ownership, curation, and technical support to make it work.
...
![image by sdi productions from istock](assets/images/istock/iStock-1199706305.jpg)
