...
# Context: Fast Moving Global Organizations# Context: Fast Moving Global Organizations {#context}



> **IN THIS SECTION, YOU WILL:** Understand the context of ideas in this book and get tips on how to contextualize your organization.
>
> **KEY POINTS:**
>
...
* *What are the unique characteristics of organizational context?*
* *What are organizational context characteristics similar to many other companies?*
* *What is the scale of your organization? How it affects architecture function?*
* *How diverse is your organization? How it affects architecture function?*
* *What are grow dynamics of your organization? How it affects architecture function?*
* *Are you experiencing synergy and transformation pressures? How it affects architecture function?*
* *How (de)centralized is your organization? How it affects architecture function?*
